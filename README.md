...
⋅⋅⋅⋅modules/ * patients functionality pertinent to several components propagate into this directory
...
Because the argument to `--name` applies to the folder name **and** the actual component name, make sure to camel case the component names.
