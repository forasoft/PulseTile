...
describe('SearchComponent', function() {
    ...
    let scope, ctrl, controller, state, template, serviceRequests, AdvancedSearch;
    ...
    it('isClickToAdvancedSearch', function() {
        expect(ctrl.isClickToAdvancedSearch).toBe(true);
    });
    it('mainSearchEnabled', function() {
