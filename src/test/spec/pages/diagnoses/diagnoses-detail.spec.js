...
describe('Diagnoses Details', function() {
  ...
  let scope, ctrl, controller, template, stateParams, state, ngRedux, diagnosesActions, DiagnosesModal, usSpinnerService;

  beforeEach(inject(($injector, $controller, _$state_, _$stateParams_, _$ngRedux_, _diagnosesActions_, _DiagnosesModal_, _usSpinnerService_) => {
